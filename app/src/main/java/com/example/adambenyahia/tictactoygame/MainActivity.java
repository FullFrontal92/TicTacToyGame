package com.example.adambenyahia.tictactoygame;
...
public class MainActivity extends AppCompatActivity {
    ...
    void CheckWinner(){
        ...
        if (Player1.contains(2) && Player1.contains(5) && Player1.contains(7)){
            Winner=1;
        }
        if (Player2.contains(2) && Player2.contains(5) && Player2.contains(7)){
            Winner=2;
        }
